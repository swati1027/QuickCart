...
const Product = () => {
    ...
    // Never allow empty string into mainImage state
    ...
    const fetchProductData = () => {
        ...
        const validImages = product?.image?.filter(Boolean) || [];
        if (validImages.length > 0) {
            updateMainImage(validImages[0]);
        }
    };
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                    ...
                    <div className="px-5 lg:px-16 xl:px-20">
                        ...
                        <div className="grid grid-cols-4 gap-4">
                            {productData?.image?.filter(Boolean).map((img, index) => (
                                <div
                                    key={index}
